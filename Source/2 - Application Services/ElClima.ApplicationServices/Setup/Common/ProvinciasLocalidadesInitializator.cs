...
namespace ElClima.ApplicationServices.Setup.Common
{
    internal static class ProvinciasLocalidadesInitializator
    {
        public static void Initialize(IUnitOfWork unitOfWork)
        {
            ...
            //var provinciasJson = Properties.Resources.ResourceManager.GetString("provinciasa_json");
            ...
            ////var paises = new Service<Pais>(unitOfWork).GetAll();
            ...
            //        localidadAInsertar.Provincia.Pais = argentina;
